...
config_file_name = "baseline_config_3"
...
df = pd.DataFrame(solution, columns=["State_Inputs", "State_Capacity", "Administrative_Complexity", "State_Integrity", "Population"])
df["time"] = t
df = df[["time", "State_Inputs", "State_Capacity", "Administrative_Complexity", "State_Integrity", "Population"]]
