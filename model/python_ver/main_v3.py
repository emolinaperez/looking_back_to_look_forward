...
from tainter_model_v3 import TainterModel
import pathlib
import logging
...
# ----------------------------
config_file_name = "ensemble_config_3"
...
def run_simulation(row, initial_state, factor_names):
    ...
    p0_values = np.array([
        ...
        model_parameters["r_population"],
        model_parameters["K_population"],
        model_parameters["ef_pop_inputs"],
        model_parameters["ef_pop_complexity"],
        model_parameters["ef_pop_capacity_drain"]
    ])
    ...
    parameters = {
        ...
        "k_integrity_gain": new_params_values[8],
        "k_integrity_loss_inputs": new_params_values[9],
        "r_population": new_params_values[10],
        "K_population": new_params_values[11],
        "ef_pop_inputs": new_params_values[12],
        "ef_pop_complexity": new_params_values[13],
        "ef_pop_capacity_drain": new_params_values[14]
    ...
    df_sol = pd.DataFrame(sol, columns=["State_Inputs", "State_Capacity", "Administrative_Complexity", "State_Integrity", "Population"])
    df_sol["time"] = t
