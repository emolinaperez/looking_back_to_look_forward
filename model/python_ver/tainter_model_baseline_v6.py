...
tm = TainterModel(debug=False)

# Define the Utils class for reading YAML files
utils = Utils()

# Load the configuration file
config_file_name = "baseline_config_6"
...
df = pd.DataFrame(solution, columns=["State_Inputs", "State_Capacity", "Administrative_Complexity"])
df["time"] = t
df = df[["time", "State_Inputs", "State_Capacity", "Administrative_Complexity"]]
